...
$execute positioned $(x) $(y) $(z) align xyz run summon marker ~43.5 ~24 ~12.5 {Tags:["mapsetup","cen"]}
$execute positioned $(x) $(y) $(z) align xyz run summon marker ~82.5 ~29 ~12.5 {Tags:["mapsetup","blu"]}
