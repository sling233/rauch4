...
execute at @s[team=Red] as @a[team=Blue,tag=game,tag=!dead,distance=..3.5] run function rauch:game/core/ability/flyer/q/hit
execute at @s[team=Blue] as @a[team=Red,tag=game,tag=!dead,distance=..3.5] run function rauch:game/core/ability/flyer/q/hit
