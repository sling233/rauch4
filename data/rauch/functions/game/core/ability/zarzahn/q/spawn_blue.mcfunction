execute at @s run tag @a[team=Red,tag=game,tag=!dead,distance=..7] add temp
...
execute at @s run summon slime ~ ~-2 ~ {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:27,Tags:["push","setup"]}
execute at @s run summon slime ~ ~-2 ~ {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:27,Tags:["push","setup"]}
execute at @s run summon slime ~ ~-2 ~ {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:27,Tags:["push","setup"]}
execute at @s run summon slime ~ ~-2 ~ {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:27,Tags:["push","setup"]}
execute at @s run summon slime ~ ~-2 ~ {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:27,Tags:["push","setup"]}
