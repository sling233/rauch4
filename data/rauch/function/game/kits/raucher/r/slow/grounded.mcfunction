...
execute at @s[tag=red] as @a[team=Blue,tag=game,tag=!dead,distance=..3.6] run function rauch:game/kits/raucher/r/slow/debuff
execute at @s[tag=blu] as @a[team=Red,tag=game,tag=!dead,distance=..3.6] run function rauch:game/kits/raucher/r/slow/debuff
