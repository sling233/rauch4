execute as @s[tag=red] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:80,Tags:["red","r_s","cloud","projectile"]}
execute as @s[tag=blu] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:80,Tags:["blu","r_s","cloud","projectile"]}
