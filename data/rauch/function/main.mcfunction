...
execute unless score Global game_running matches 1 if score Global setting_always_enable_launchpads matches 1 as @a run function rauch:game/mechanics/launchpads/check_for_launchpads
