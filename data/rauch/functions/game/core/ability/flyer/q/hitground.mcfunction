...
execute at @s run execute at @s run playsound minecraft:item.totem.use master @a
...
execute at @s[team=Red] as @a[team=Blue,tag=game,tag=!dead,distance=..3.5] run scoreboard players set @s stun 60
execute at @s[team=Red] as @a[team=Blue,tag=game,tag=!dead,distance=..3.5] run function rauch:game/core/mechanics/stuninit
execute at @s[team=Red] as @a[team=Blue,tag=game,tag=!dead,distance=..3.5] run effect give @s minecraft:instant_damage 1 3 true
execute at @s[team=Blue] as @a[team=Red,tag=game,tag=!dead,distance=..3.5] run scoreboard players set @s stun 60
execute at @s[team=Blue] as @a[team=Red,tag=game,tag=!dead,distance=..3.5] run function rauch:game/core/mechanics/stuninit
execute at @s[team=Blue] as @a[team=Red,tag=game,tag=!dead,distance=..3.5] run effect give @s minecraft:instant_damage 1 3 true
