...
execute as @s[tag=flyer_q_ground] run scoreboard players set $y player_motion.api.launch 10000
execute as @s[tag=flyer_q_ground] run function player_motion:api/launch_xyz
...
execute as @e[type=area_effect_cloud,tag=setup,tag=flyerq,limit=1] run function rauch:game/ability/flyer/q/floor
