...
execute if score Global mod9 matches 0 at @s[tag=red] as @a[team=Red,tag=game,tag=!dead,distance=..3.1,nbt=!{active_effects:[{id:"minecraft:regeneration"}]}] run execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0,Duration:6,Age:4,effects:[{id:"minecraft:regeneration",amplifier:127b,duration:1,show_particles:0b}]}
execute if score Global mod9 matches 0 at @s[tag=blu] as @a[team=Blue,tag=game,tag=!dead,distance=..3.1,nbt=!{active_effects:[{id:"minecraft:regeneration"}]}] run execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0,Duration:6,Age:4,effects:[{id:"minecraft:regeneration",amplifier:127b,duration:1,show_particles:0b}]}
