...
execute as @s[scores={kitselect=100}] run scoreboard players set @s hide_ambient_particles 0
execute as @s[scores={kitselect=101}] run scoreboard players set @s hide_ambient_particles 1
...
clear @s minecraft:written_book[custom_name='{"text":"Kit Selector/Settings","color":"yellow","italic":false}']
