...
execute at @s[team=Red] as @a[team=Red,distance=..5] unless score @s pnum = @p pnum run scoreboard players operation @s heal = @p tank_damage_taken
execute at @s[team=Blue] as @a[team=Blue,distance=..5] unless score @s pnum = @p pnum run scoreboard players operation @s heal = @p tank_damage_taken
