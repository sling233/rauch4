...
function rauch:game/kits/raucher/q/remove_attribute_macro with storage temp

scoreboard objectives remove calc

# loop logic --------------------------------------
scoreboard players add Global i 1
execute if score Global i < Global end_value run function rauch:game/kits/raucher/q/remove_buff_loop
