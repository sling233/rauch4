execute as @s[scores={kit=3,cool1=0}] if score @s projectileRNum < @s projectileRMax run function rauch:game/kits/raucher/r/addcloud
...
execute as @s[scores={kit=9}] run function rauch:game/kits/wokkaman/wokkaman_cooldowns
