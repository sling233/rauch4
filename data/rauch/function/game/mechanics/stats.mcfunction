...
attribute @s[scores={kit=1}] minecraft:generic.armor modifier add armorfix -13 add_value
attribute @s[scores={kit=2}] minecraft:generic.armor modifier add armorfix -4 add_value
attribute @s[scores={kit=3}] minecraft:generic.armor modifier add armorfix -9 add_value
attribute @s[scores={kit=4}] minecraft:generic.armor modifier add armorfix -6 add_value
attribute @s[scores={kit=5}] minecraft:generic.armor modifier add armorfix -17 add_value
attribute @s[scores={kit=6}] minecraft:generic.armor modifier add armorfix -6 add_value
attribute @s[scores={kit=7}] minecraft:generic.armor modifier add armorfix -17 add_value
attribute @s[scores={kit=8}] minecraft:generic.armor modifier add armorfix 0 add_value
attribute @s[scores={kit=9}] minecraft:generic.armor modifier add armorfix -6 add_value

attribute @s[scores={kit=5}] minecraft:generic.knockback_resistance modifier add kbfix -0.30000000447034836 add_value
