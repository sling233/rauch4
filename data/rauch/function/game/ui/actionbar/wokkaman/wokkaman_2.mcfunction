...
execute if score @s cool2 matches 1.. run data modify storage temp wokkaman_actionbar.q set value "gray"
execute if score @s cool2 matches 1.. run data modify storage temp wokkaman_actionbar.bracketq set value "dark_gray"
...
function rauch:game/ui/actionbar/wokkaman/wokkaman_2_macro with storage temp wokkaman_actionbar
