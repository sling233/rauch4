...
execute at @a[tag=t_stunned] facing entity @s feet positioned ~ ~-0.5 ~ run summon slime ^ ^ ^0.5 {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:6,Tags:["wok_push","setup"]}
execute at @a[tag=t_stunned] facing entity @s feet positioned ~ ~-0.5 ~ run summon slime ^ ^ ^0.5 {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:6,Tags:["wok_push","setup"]}
execute at @a[tag=t_stunned] facing entity @s feet positioned ~ ~-0.5 ~ run summon slime ^ ^ ^0.5 {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:6,Tags:["wok_push","setup"]}
execute at @a[tag=t_stunned] facing entity @s feet positioned ~ ~-0.5 ~ run summon slime ^ ^ ^0.5 {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:6,Tags:["wok_push","setup"]}
execute at @a[tag=t_stunned] facing entity @s feet positioned ~ ~-0.5 ~ run summon slime ^ ^ ^0.5 {Team:"Blue",Invulnerable:1b,Silent:1b,NoAI:1b,Size:6,Tags:["wok_push","setup"]}
