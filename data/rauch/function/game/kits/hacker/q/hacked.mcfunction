...
execute as @a[tag=t_hacker] run function rauch:macros/foreach {for_path:"macros data.list",for_function:"rauch:game/kits/hacker/q/tag/check_new"}
execute unless score Global found matches 1 run function rauch:game/kits/hacker/q/tag/check_not_found
