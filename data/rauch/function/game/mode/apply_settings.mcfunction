...
execute if score Global mode matches 6 run return run function rauch:game/mode/try/settings
execute if score Global mode matches 7 run return run function rauch:game/mode/spawn_check/settings
