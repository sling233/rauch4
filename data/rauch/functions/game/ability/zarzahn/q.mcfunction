execute at @s[team=Red] run summon marker ~ ~ ~ {Tags:["projectile","zarzahn_rocket","setup","red"]}
execute at @s[team=Blue] run summon marker ~ ~ ~ {Tags:["projectile","zarzahn_rocket","setup","blu"]}
