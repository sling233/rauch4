...
execute at @s as @e[type=marker,tag=wark_detect] if score @s wark_startup = @p pnum at @a if score @s pnum = @p pnum as @p run function rauch:game/ability/wark/q/buff_init
