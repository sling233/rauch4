...
function rauch:macros/foreach {for_path:"macros data.list",for_function:"rauch:game/kits/wokkaman/sr/tagging"}
# tag wokka
...
function rauch:game/kits/wokkaman/sr/move_macro with storage temp

function rauch:macros/data_write {storage:"wok_bow_tag"}
...
execute as @s[scores={click=30..}] run function rauch:game/kits/wokkaman/sr/destroy
