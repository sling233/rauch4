...
execute as @s[team=!Red,team=!Blue] if score Global time_red <= Global time_blue run say i join red
execute as @s[team=!Red,team=!Blue] if score Global time_red <= Global time_blue run team join Red @s
execute as @s[team=!Red,team=!Blue] if score Global time_red > Global time_blue run say i join blue
