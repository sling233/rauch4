$item replace entity @s hotbar.8 with written_book{title:"Kit Selector / Settings",author:"",pages:['[{"text":"           "},{"text":"Kits\\n\\n","bold":true},{"text":"[","color":"dark_gray"},\
...
[{"text":"Name: ","color":"gray"},{"text":"Raucher\\n","color":"gold"},{"text":"Type: ","color":"gray"},{"text":"Support\\n","color":"dark_green"},\
{"text":"Stats:  "},{"text":"❤12  ","color":"light_purple"},{"text":"⚔0.9\\n\\n","color":"blue"},{"text":"R: ","color":"gold"},\
{"text":"You shoot a Rocket that launches Players when it explodes\\n\\n"},{"text":"Q: ","color":"gold"},\
{"text":"Buffs damage for a teammate by 50% for 5 seconds (look at them and press Q)\\n\\n"},{"text":"F: ","color":"gold"},\
{"text":"You throw a Damage Cloud that slows enemies and increases their received damage by 40%. Hold Sneak to throw a Health Cloud that gives your teammates regeneration. You can store multiple clouds."}]}},{"text":"]\\n[","color":"dark_gray"},\
...
{"text":"Stats:  "},{"text":"❤15  ","color":"light_purple"},{"text":"⚔1.1\\n\\n","color":"blue"},{"text":"R: ","color":"gold"},\
...
'[{"text":"   "},{"text":"Other Settings\\n\\n\\n","bold":"true"},{"text":"Ambient Particles:\\n","hoverEvent":{"action":"show_text","contents":[{"text":"Turns Ambient Particles On/Off. Some Maps may not have Ambient Particles. This can help a bit with performance problems.","color":"white"}]}},{"text":" [","color":"dark_gray"},{"text":"Off","color":"$(not_ambient)","clickEvent":{"action":"run_command","value":"/trigger kitselect set 100"}},{"text":"]      [","color":"dark_gray"},{"text":"On","color":"$(ambient)","clickEvent":{"action":"run_command","value":"/trigger kitselect set 101"}},{"text":"]\\n\\n","color":"dark_gray"},{"text":"Particle Density:\\n","hoverEvent":{"action":"show_text","contents":[{"text":"Changes how many particles are rendered for certain effects. Setting this to \\"Low\\" can help a bit with performance.","color":"white"}]}},{"text":" [","color":"dark_gray"},{"text":"Low","color":"$(not_density)","clickEvent":{"action":"run_command","value":"/trigger kitselect set 103"}},{"text":"]     [","color":"dark_gray"},{"text":"High","color":"$(density)","clickEvent":{"action":"run_command","value":"/trigger kitselect set 104"}},{"text":"]\\n\\n","color":"dark_gray"},{"text":"Teleport to Spawn","color":"dark_blue","clickEvent":{"action":"run_command","value":"/trigger kitselect set 105"},"hoverEvent":{"action":"show_text","contents":[{"text":"Click to teleport back to spawn"}]}}]'],display:{Name:'{"text":"Kit Selector/Settings","color":"yellow","italic":false}'}} 1
