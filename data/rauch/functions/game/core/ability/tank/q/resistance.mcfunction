...
execute at @s[team=Red] as @a[team=Red,distance=..5] unless score @s pnum = @p pnum run effect give @s minecraft:resistance 1 0
execute at @s[team=Blue] as @a[team=Blue,distance=..5] unless score @s pnum = @p pnum run effect give @s minecraft:resistance 1 0
