...
summon item ~ ~1.6 ~ {Tags:["setup"],CustomNameVisible:1b,Age:5990,PickupDelay:32767,Motion:[0.1,0.3,0.005],CustomName:'{"text":"f"}',Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:0}}}
