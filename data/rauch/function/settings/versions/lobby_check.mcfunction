...
execute if score t_lobby_id temp matches 3 run tellraw @a {"text":"No Update found","color":"yellow"}
execute unless score t_lobby_id temp matches 3 run tellraw @a [{"text":"An Update is available for the prebuilt lobby. Click ","color":"yellow"},\
