...
execute as @s[scores={flyerFSchedule=-1}] run attribute @s minecraft:gravity base set 0.08
...
execute as @s[scores={wok_hover_schedule=-1}] run attribute @s minecraft:gravity base set 0.08
execute as @s[tag=t_grounded] run tag @s add wok_f_air
execute as @s[tag=t_grounded] unless score @s flyerFSchedule matches ..0 unless score @s push_levitation_timer matches ..0 run attribute @s minecraft:gravity base set 0.08
