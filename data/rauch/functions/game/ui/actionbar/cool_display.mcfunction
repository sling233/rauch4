execute unless score @s kit matches 3..5 unless score @s kit matches 7 unless score @s kit matches 9 run function rauch:game/ui/actionbar/cooldisnor
...
execute if score @s kit matches 9 run function rauch:game/ui/actionbar/cooldis_wokkaman
