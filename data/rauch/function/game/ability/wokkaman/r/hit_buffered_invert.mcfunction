...
# else spawn vehicle
execute as @a if score @s pnum = t_pnum temp at @s run summon minecraft:block_display ~ ~0.4 ~ {Tags:["wok_vehicle","setup"]}
...
execute as @a if score @s pnum = t_pnum temp run function rauch:game/ability/wokkaman/hr
