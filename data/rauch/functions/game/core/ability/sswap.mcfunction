...
execute as @s[scores={cool3=0,kit=2},predicate=!rauch:sneak,predicate=!rauch:hack,predicate=!rauch:stun] run function rauch:game/core/ability/dash/sdash
...
execute as @s[predicate=rauch:hack] run tellraw @s {"text":"You are hacked and cannot dash!","color":"red"}
execute as @s[predicate=rauch:hack] run playsound minecraft:block.chain.break master @s
execute as @s[predicate=rauch:stun] run tellraw @s {"text":"You are stunned and cannot dash!","color":"red"}
