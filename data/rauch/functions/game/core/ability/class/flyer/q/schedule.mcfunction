...
execute if score @s flyerQSchedule matches -58 as @s[tag=flyer_q_ground] run effect give @s minecraft:levitation 2 255 true
...
execute at @s as @e[type=area_effect_cloud,tag=flyerq] if score @s pnum = @p pnum run function rauch:game/core/ability/class/flyer/q/particle
