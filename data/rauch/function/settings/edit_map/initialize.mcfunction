...
tellraw @s [{"text":"Map ","color":"yellow"},{"score":{"name":"Global","objective":"number_of_maps"},"color":"light_purple"},{"text":"/8                                "},{"text":"[Guide]","click_event":{"action":"run_command","command":"/function rauch:tutorial/tutorialmap"}}]
