...
execute if score Global t_lobby_id matches 3 run tellraw @a {"text":"No Update found","color":"yellow"}
execute unless score Global t_lobby_id matches 3 run tellraw @a [{"text":"An Update is available for the prebuilt lobby. Click ","color":"yellow"},\
