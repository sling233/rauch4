...
execute if score t_list_count temp matches 1 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 2.4 add_value
execute if score t_list_count temp matches 2 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 4.8 add_value
execute if score t_list_count temp matches 3 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 7.2 add_value
execute if score t_list_count temp matches 4 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 9.6 add_value
execute if score t_list_count temp matches 5 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 12 add_value
execute if score t_list_count temp matches 6 run attribute @s minecraft:generic.attack_damage modifier add boltdmg 14.4 add_value
