...
execute at @s[team=Red] as @a[team=Blue,tag=game,tag=!dead,distance=..4] run function rauch:game/ability/flyer/q/hit
execute at @s[team=Blue] as @a[team=Red,tag=game,tag=!dead,distance=..4] run function rauch:game/ability/flyer/q/hit
