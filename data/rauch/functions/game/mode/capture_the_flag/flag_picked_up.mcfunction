...
execute as @s[team=Red] store result score Global yPos run data get entity @e[type=marker,tag=map,tag=t2,limit=1] Pos[0]
execute as @s[team=Blue] store result score Global yPos run data get entity @e[type=marker,tag=map,tag=t1,limit=1] Pos[0]
scoreboard players operation Global xPos -= Global yPos

execute store result score Global zPos run data get entity @s Pos[2]
execute as @s[team=Red] store result score Global yPos run data get entity @e[type=marker,tag=map,tag=t2,limit=1] Pos[2]
execute as @s[team=Blue] store result score Global yPos run data get entity @e[type=marker,tag=map,tag=t1,limit=1] Pos[2]
