...
execute as @s[scores={adminsetting=1..4}] if score Global mode matches 0 run tellraw @a [{"text":"Mode: Deathmatch","color":"green"}]
execute as @s[scores={adminsetting=1..4}] if score Global mode matches 1 run tellraw @a [{"text":"Mode: King of the Hill","color":"green"}]
execute as @s[scores={adminsetting=1..4}] if score Global mode matches 2 run tellraw @a [{"text":"Mode: Respawn Deathmatch","color":"green"}]
execute as @s[scores={adminsetting=1..4}] if score Global mode matches 3 run tellraw @a [{"text":"Mode: Testing Mode","color":"green"}]
