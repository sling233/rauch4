...
execute store result storage map_data edit_buffer.blue[0] double 0.1 run scoreboard players get t_posx temp
execute store result storage map_data edit_buffer.blue[1] double 0.1 run scoreboard players get t_posy temp
execute store result storage map_data edit_buffer.blue[2] double 0.1 run scoreboard players get t_posz temp

#tellraw @s {"text":"----------------------------------------------------", "color":"yellow"}
tellraw @s [{"text":"Blue Spawn set to: ", "color":"yellow"},{"nbt":"edit_buffer.blue[0]","storage":"map_data","color":"light_purple"},{"text":", "},{"nbt":"edit_buffer.blue[1]","storage":"map_data","color":"light_purple"},{"text":", "},{"nbt":"edit_buffer.blue[2]","storage":"map_data","color":"light_purple"}]
#tellraw @s {"text":"----------------------------------------------------", "color":"yellow"}
execute at @s run playsound minecraft:block.tripwire.click_off master @s ~ ~ ~ 1
function rauch:settings/edit_map/give/give_blue_spawn
