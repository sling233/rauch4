data modify storage map_data maps prepend value {name:"Arena",id:6,red:[],blue:[],center:[],particle:-1,time:-1,weather:-1,has_launchpads:-1,disable_block_interaction:-1,version:-1,spawn_location:[]}
