...
execute at @s[tag=red] positioned ~-0.5 ~-0.5 ~-0.5 if entity @a[team=Blue,tag=!dead,dx=0,dy=0,dz=0,limit=1] run function rauch:game/core/ability/class/zarzahn/r/hit
execute at @s[tag=blu] positioned ~-0.5 ~-0.5 ~-0.5 if entity @a[team=Red,tag=!dead,dx=0,dy=0,dz=0,limit=1] run function rauch:game/core/ability/class/zarzahn/r/hit
