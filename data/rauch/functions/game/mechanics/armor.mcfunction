...
execute as @s[scores={armor_target=18},tag=!flagPickedUp] run item replace entity @s armor.head with warped_fungus_on_a_stick{display:{Name:'{"text":"Pssssst","color":"aqua","italic":false}'},HideFlags:1,CustomModelData:0,Enchantments:[{id:"minecraft:protection",lvl:18s},{id:"minecraft:binding_curse",lvl:1s}]} 1
execute as @s[scores={armor_target=20},tag=flagPickedUp] run item replace entity @s[tag=flagPickedUp,team=Red] armor.head with red_banner{display:{Name:'{"text":"Flag","color":"aqua","italic":false}'},HideFlags:1,CustomModelData:0,Enchantments:[{id:"minecraft:protection",lvl:20s},{id:"minecraft:binding_curse",lvl:1s}]} 1
execute as @s[scores={armor_target=20},tag=flagPickedUp] run item replace entity @s[tag=flagPickedUp,team=Blue] armor.head with blue_banner{display:{Name:'{"text":"Flag","color":"aqua","italic":false}'},HideFlags:1,CustomModelData:0,Enchantments:[{id:"minecraft:protection",lvl:20s},{id:"minecraft:binding_curse",lvl:1s}]} 1
execute as @s[scores={armor_target=18},tag=flagPickedUp] run item replace entity @s[tag=flagPickedUp,team=Red] armor.head with red_banner{display:{Name:'{"text":"Flag","color":"aqua","italic":false}'},HideFlags:1,CustomModelData:0,Enchantments:[{id:"minecraft:protection",lvl:18s},{id:"minecraft:binding_curse",lvl:1s}]} 1
execute as @s[scores={armor_target=18},tag=flagPickedUp] run item replace entity @s[tag=flagPickedUp,team=Blue] armor.head with blue_banner{display:{Name:'{"text":"Flag","color":"aqua","italic":false}'},HideFlags:1,CustomModelData:0,Enchantments:[{id:"minecraft:protection",lvl:18s},{id:"minecraft:binding_curse",lvl:1s}]} 1
