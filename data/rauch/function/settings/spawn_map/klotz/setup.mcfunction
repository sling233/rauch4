data modify storage map_data maps prepend value {name:"Klotz 2.0",id:5,red:[],blue:[],center:[],particle:-1,time:-1,weather:-1,has_launchpads:-1,disable_block_interaction:-1,is_dark:-1,version:-1,spawn_location:[]}
