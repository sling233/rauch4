...
#execute if score @s wokkaman_weapon matches 4 run item replace entity @s[scores={kit=9}] hotbar.0 with minecraft:carrot_on_a_stick[item_model="rauch:pikspeer",item_name={"text":"Piksspeer"},rarity=epic,unbreakable={}] 1
