...
execute as @e[type=item_display,tag=wok_rocket,tag=rotating] if score @s pnum = t_pnum temp run function rauch:game/ability/wokkaman/q/tag_rocket_for_shooting
