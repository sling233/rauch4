execute at @s[tag=red] as @a[team=Blue,tag=game,tag=!dead,distance=..5.5] run function rauch:game/core/ability/hacker/q/hacked
execute at @s[tag=blu] as @a[team=Red,tag=game,tag=!dead,distance=..5.5] run function rauch:game/core/ability/hacker/q/hacked
