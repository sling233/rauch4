...
# damage queue
execute as @p run function rauch:game/mechanics/dmg_queue/find_me
...
execute if entity @s[scores={raucherdmg=1..}] run function rauch:game/mechanics/dmg_queue/apply_raucher_buff
tag @p add dmg_queue
