...
execute if score @s flyerQSchedule matches -28.. if predicate rauch:on_ground run function rauch:game/kits/flyer/q/hitground
execute if score @s flyerQSchedule matches -57..-29 as @s[tag=allow_cancel] if predicate rauch:on_ground run function rauch:game/kits/flyer/q/hitground
execute if score @s flyerQSchedule matches -1.. run attribute @s minecraft:gravity base reset

execute at @s as @e[type=area_effect_cloud,tag=flyerq] if score @s pnum = @p pnum run function rauch:game/kits/flyer/q/particle
