...
execute at @s[tag=red,scores={10=0}] as @a[team=Red,tag=!dead,distance=..3.1,nbt=!{ActiveEffects:[{Id:10b}]}] run execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0,Duration:6,Age:4,Effects:[{Id:10b,Amplifier:127b,Duration:1,ShowParticles:0b}]}
execute at @s[tag=blu,scores={10=0}] as @a[team=Blue,tag=!dead,distance=..3.1,nbt=!{ActiveEffects:[{Id:10b}]}] run execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0,Duration:6,Age:4,Effects:[{Id:10b,Amplifier:127b,Duration:1,ShowParticles:0b}]}
