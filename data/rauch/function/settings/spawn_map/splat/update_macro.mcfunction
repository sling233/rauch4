...
# map values
$data modify storage map_data maps[$(index)].version set value 6
...
$execute positioned $(x) $(y) $(z) align xyz run summon marker ~70.5 ~29 ~11.5 {Tags:["mapsetup","blu"]}
$execute positioned $(x) $(y) $(z) align xyz run place template rauch:splat1 ~ ~ ~
$execute positioned $(x) $(y) $(z) align xyz run place template rauch:splat2 ~48 ~ ~
