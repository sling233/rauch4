...
execute if score @s flyerQSchedule matches -28.. if predicate rauch:on_ground run function rauch:game/ability/flyer/q/hitground
execute if score @s flyerQSchedule matches -57..-29 as @s[tag=allow_cancel] if predicate rauch:on_ground run function rauch:game/ability/flyer/q/hitground
