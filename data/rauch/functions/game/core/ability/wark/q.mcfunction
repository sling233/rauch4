execute at @s[team=Red] run function rauch:game/core/ability/wark/q/detectred
execute at @s[team=Blue] run function rauch:game/core/ability/wark/q/detectblue

scoreboard players set Global wark_startup 9999999
execute as @a[tag=temp] run function rauch:game/core/ability/wark/q/evaluate
execute at @s as @a[tag=least,limit=1] run function rauch:game/core/ability/wark/q/hit
