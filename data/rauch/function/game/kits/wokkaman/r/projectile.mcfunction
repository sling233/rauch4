...
execute at @s[tag=red,tag=!hit] positioned ~-1 ~-1 ~-1 as @a[team=Blue,tag=game,tag=!dead,tag=!zarzahn_hook,tag=!wok_hook,dx=1,dy=1,dz=1,limit=1] run function rauch:game/kits/wokkaman/r/hit
execute at @s[tag=blu,tag=!hit] positioned ~-1 ~-1 ~-1 as @a[team=Red,tag=game,tag=!dead,tag=!zarzahn_hook,tag=!wok_hook,dx=1,dy=1,dz=1,limit=1] run function rauch:game/kits/wokkaman/r/hit
