...
execute as @s as @e[type=armor_stand,tag=r_s,tag=setup,sort=nearest] store result entity @s Motion[0] double 0.000017 run scoreboard players get @s xPos
execute as @s as @e[type=armor_stand,tag=r_s,tag=setup,sort=nearest] store result entity @s Motion[1] double 0.000017 run scoreboard players get @s yPos
execute as @s as @e[type=armor_stand,tag=r_s,tag=setup,sort=nearest] store result entity @s Motion[2] double 0.000017 run scoreboard players get @s zPos
