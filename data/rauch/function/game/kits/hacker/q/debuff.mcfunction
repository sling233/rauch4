...
execute as @s[scores={hacker_damage_timer=..0}] run function rauch:game/mechanics/set_protection
execute as @s[scores={hacker_damage_timer=..0}] run function rauch:game/kits/hacker/q/remove_me
