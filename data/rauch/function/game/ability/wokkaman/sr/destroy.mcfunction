...
execute as @s[tag=hit_something] at @s run particle flash ~ ~ ~ 0 0 0 1 1 force
...
function rauch:macros/foreach {for_path:"macros data.list",for_function:"rauch:game/ability/wokkaman/sr/stun_foreach"}
