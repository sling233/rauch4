execute as @s[team=Red] run function rauch:game/core/ability/class/zarzahn/q/spawn_red
execute as @s[team=Blue] run function rauch:game/core/ability/class/zarzahn/q/spawn_blue
