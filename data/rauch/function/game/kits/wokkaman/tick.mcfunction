execute as @s[scores={slime_despawn_timer=-1}] run function rauch:game/kits/wokkaman/r/despawn
...
execute as @s[tag=flying,tag=t_grounded] run function rauch:game/kits/wokkaman/f/land
execute as @s[scores={elytra=0..}] run function rauch:game/kits/wokkaman/f/elytra_cooldown
