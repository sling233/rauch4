data modify storage map_data maps prepend value {name:"Mork",id:4,red:[],blue:[],center:[],particle:11,time:-1,version:-1,weather:-1,has_launchpads:-1,disable_block_interaction:-1,spawn_location:[]}
