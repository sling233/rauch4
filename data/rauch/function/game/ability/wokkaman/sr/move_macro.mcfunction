...
execute at @s[tag=!searching,tag=red] positioned ~-0.5 ~-0.5 ~-0.5 as @a[team=Blue,tag=game,tag=!dead,dx=0,dy=0,dz=0] if score @s pnum = t_target_pnum temp run function rauch:game/ability/wokkaman/sr/hit
execute at @s[tag=!searching,tag=blu] positioned ~-0.5 ~-0.5 ~-0.5 as @a[team=Red,tag=game,tag=!dead,dx=0,dy=0,dz=0] if score @s pnum = t_target_pnum temp run function rauch:game/ability/wokkaman/sr/hit
tag @s remove temp
