...
execute if score @s kit matches 3 run return run return 0
...
execute if score @s kit matches 6 run return run return 0
execute if score @s kit matches 7 run return run return 0
execute if score @s kit matches 8 run return run function rauch:game/kits/pikka/hack_init
execute if score @s kit matches 9 run return run function rauch:game/kits/wokkaman/hack_init


tellraw @s [{text:"",color:"red"},"Error when trying to run hack_init function for ",{"selector":"@s"},": not implemented for kit id ",{"score":{"name":"@s","objective":"kit"}}]
