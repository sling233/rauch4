...
execute store result entity @s Motion[0] double 0.0000006 run scoreboard players get @s xPos
execute store result entity @s Motion[1] double 0.0000006 run scoreboard players get @s yPos
execute store result entity @s Motion[2] double 0.0000006 run scoreboard players get @s zPos
