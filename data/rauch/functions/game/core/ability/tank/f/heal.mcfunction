execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["heal","setup"],Radius:0,Duration:6,Age:4,Effects:[{Id:10,Amplifier:127b,Duration:2,ShowParticles:0b}]}
