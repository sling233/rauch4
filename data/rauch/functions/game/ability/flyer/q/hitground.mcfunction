...
execute at @s[team=Red] as @e[team=Blue,tag=rauch_damagable,distance=..3.5] run damage @s 10
execute at @s[team=Blue] as @e[team=Red,tag=rauch_damagable,distance=..3.5] run damage @s 10
