...
execute at @p run summon item_display ~ ~ ~ {UUID:[I;-698710071,-633058886,-1943178672,1016033168]}
...
execute store result score t_bossbar_max temp run data get entity d65a87c9-da44-49ba-8c2d-72503c8f6f90 transformation.scale[0] 20
