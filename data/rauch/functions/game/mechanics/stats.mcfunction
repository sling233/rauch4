attribute @s minecraft:generic.attack_speed base set 100000
#attribute @s minecraft:generic.armor_toughness base set 20

attribute @s[scores={kit=1}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -13 add_value
attribute @s[scores={kit=2}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -4 add_value
attribute @s[scores={kit=3}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -9 add_value
attribute @s[scores={kit=4}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -6 add_value
attribute @s[scores={kit=5}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -17 add_value
attribute @s[scores={kit=6}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -6 add_value
attribute @s[scores={kit=7}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -17 add_value
attribute @s[scores={kit=8}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" 0 add_value
attribute @s[scores={kit=9}] minecraft:generic.armor modifier add 0-0-0-1-0 "armorfix" -6 add_value

attribute @s[scores={kit=5}] minecraft:generic.knockback_resistance modifier add 0-0-0-2-0 "kbfix" -0.30000000447034836 add_value
...
attribute @s[scores={kit=3}] minecraft:generic.attack_damage base set 9
attribute @s[scores={kit=4}] minecraft:generic.attack_damage base set 11
attribute @s[scores={kit=5}] minecraft:generic.attack_damage base set 12
attribute @s[scores={kit=6}] minecraft:generic.attack_damage base set 28
