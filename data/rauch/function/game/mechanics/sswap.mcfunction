...
execute if score Global gamestart matches 0.. run return 2

execute unless predicate rauch:sneak run function rauch:game/kits/f
execute if predicate rauch:sneak run function rauch:game/kits/sf