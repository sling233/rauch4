...
execute at @s[tag=red] run particle minecraft:dust{color:[0.3,0.0,0.0],scale:1} 1 ^ ^0.2 ^3.5 0.05 0.05 0.05 1 1 force
execute at @s[tag=blu] run particle minecraft:dust{color:[0.0,0.0,0.3],scale:1} ^ ^0.2 ^3.5 0.05 0.05 0.05 1 1 force
execute at @s[tag=red] run particle minecraft:dust{color:[0.3,0.0,0.0],scale:1} 1 ^ ^0.2 ^-3.5 0.05 0.05 0.05 1 1 force
execute at @s[tag=blu] run particle minecraft:dust{color:[0.0,0.0,0.3],scale:1} ^ ^0.2 ^-3.5 0.05 0.05 0.05 1 1 force
execute at @s[tag=red] run particle minecraft:dust{color:[0.3,0.0,0.0],scale:1} 1 ^3.5 ^0.2 ^ 0.05 0.05 0.05 1 1 force
execute at @s[tag=blu] run particle minecraft:dust{color:[0.0,0.0,0.3],scale:1} ^3.5 ^0.2 ^ 0.05 0.05 0.05 1 1 force
execute at @s[tag=red] run particle minecraft:dust{color:[0.3,0.0,0.0],scale:1} 1 ^-3.5 ^0.2 ^ 0.05 0.05 0.05 1 1 force
execute at @s[tag=blu] run particle minecraft:dust{color:[0.0,0.0,0.3],scale:1} ^-3.5 ^0.2 ^ 0.05 0.05 0.05 1 1 force

execute at @s[tag=red] run particle minecraft:dust{color:[0.3,0.0,0.0],scale:1} 1 ^2.47 ^0.2 ^2.47 0.05 0.05 0.05 1 1 force
