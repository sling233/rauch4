...
data modify storage temp wokkaman_actionbar set value {q:"dark_purple",f:"dark_green",r:"gold",sq:"#2121FF",sf:"dark_green",sr:"gold"}
...
execute if score @s cool3 matches 1.. run data modify storage temp wokkaman_actionbar.f set value "green"
execute if score @s cool4 matches 1.. run data modify storage temp wokkaman_actionbar.sr set value "green"
execute if score @s cool5 matches 1.. run data modify storage temp wokkaman_actionbar.sq set value "#7474fc"
execute if score @s cool6 matches 1.. run data modify storage temp wokkaman_actionbar.sf set value "green"
