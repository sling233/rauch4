...
# launch
execute at @s if block ~ ~-0.1 ~ ochre_froglight run function rauch:game/mechanics/launch/launch1
execute at @s if block ~ ~-0.1 ~ verdant_froglight run function rauch:game/mechanics/launch/launch2
execute at @s if block ~ ~-0.1 ~ pearlescent_froglight run function rauch:game/mechanics/launch/launch3
