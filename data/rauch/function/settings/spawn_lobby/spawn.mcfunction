...
# not successful
execute if score t_success temp matches 0 run tellraw @s {"text":"Lobby could not spawn correctly as the area was not fully loaded.","color":"red"}
...
return run scoreboard players reset * temp
