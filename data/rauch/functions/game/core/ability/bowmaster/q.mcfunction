...
#execute at @s as @e[type=arrow,tag=bow,tag=setup] run function rauch:game/core/ability/bowmaster/q/launch
execute at @s as @e[type=firework_rocket,tag=bow,tag=setup] run function rauch:game/core/ability/bowmaster/q/launch
