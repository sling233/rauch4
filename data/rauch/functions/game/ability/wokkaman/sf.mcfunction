...
execute unless entity @a[tag=t_hit] at @s[team=Red] as @a[team=Blue,tag=!dead,tag=game] facing entity @s feet positioned ^ ^ ^2 rotated as @a[tag=temp,limit=1] positioned ^ ^ ^-2 if entity @a[tag=temp,limit=1,distance=..1] run tag @s add t_hit
...
execute unless entity @a[tag=t_hit] at @s[team=Blue] as @a[team=Red,tag=!dead,tag=game] facing entity @s feet positioned ^ ^ ^2 rotated as @a[tag=temp,limit=1] positioned ^ ^ ^-2 if entity @a[tag=temp,limit=1,distance=..1] run tag @s add t_hit

execute at @s as @a[tag=t_hit,sort=nearest,limit=1] run function rauch:game/ability/wokkaman/sf/hit
