...
execute at @s[team=Red] as @a[team=Red,tag=game,distance=..4] run function rauch:game/kits/wokkaman/sq/floor_reached_damage
execute at @s[team=Blue] as @a[team=Blue,tag=game,distance=..4] run function rauch:game/kits/wokkaman/sq/floor_reached_damage
#tag @a remove t_damager
function rauch:game/kits/wokkaman/sq/un_step_on
