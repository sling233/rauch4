...
execute as @s[tag=!flyer_q_ground] run effect give @s minecraft:levitation 2 255 true
execute as @s[tag=flyer_q_ground] run effect give @s minecraft:levitation 2 80 true
...
execute as @e[type=minecraft:area_effect_cloud,tag=setup,tag=flyerq,limit=1] run function rauch:game/core/ability/class/flyer/q/floor
