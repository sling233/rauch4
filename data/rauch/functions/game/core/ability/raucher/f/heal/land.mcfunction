execute as @s[tag=red] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:70,Tags:["red","r_h","cloud","projectile"]}
execute as @s[tag=blu] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:70,Tags:["blu","r_h","cloud","projectile"]}
