...
{"text":" Tank\n","color":"$(tank)",\
   ...
   "hover_event":{"action":"show_text","value":[\
       ...
       {"text":"Q (18s): ","color":"#6E69FF"},{"text":"Buffs knockback resistance and resistance for a teammate by 40% for 6 seconds (look at them and press Q). Additionally, team members in a 4.5 block radius around the buffed player recieve 20% less damage.\n\n"},\
...
{"text":" Pikka\n","color":"$(pikka)",\
   ...
   "hover_event":{"action":"show_text","value":[\
       ...
       {"text":"R (15s): ","color":"#FFBF47"},{"text":"A Boost in momentum forwards. Way more useful in the air.\n\n"},\
       {"text":"Q (15s): ","color":"#FFBF47"},{"text":"When grounded, you rise in the air. If you already are in the air you simply stall for a bit. After a short while you slam into the ground, dealing 4.8❤ and stunning everyone in range for 1 second.\n\n"},\
