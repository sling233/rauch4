...
tellraw @s [{"text":"Map ","color":"yellow"},{"score":{"name":"Global","objective":"mapId"},"color":"light_purple"},{"text":"/8                                "},{"text":"[Guide]","clickEvent":{"action":"run_command","value":"/function rauch:tutorial/tutorialmap"}}]
