...
execute at @s[team=Red] as @a[team=Blue,distance=..3.5] run scoreboard players set @s stun 60
execute at @s[team=Red] as @a[team=Blue,distance=..3.5] run function rauch:game/core/mechanics/stuninit
execute at @s[team=Red] as @a[team=Blue,distance=..3.5] run effect give @s minecraft:instant_damage 1 3 true
execute at @s[team=Blue] as @a[team=Red,distance=..3.5] run scoreboard players set @s stun 60
execute at @s[team=Blue] as @a[team=Red,distance=..3.5] run function rauch:game/core/mechanics/stuninit
execute at @s[team=Blue] as @a[team=Red,distance=..3.5] run effect give @s minecraft:instant_damage 1 3 true
